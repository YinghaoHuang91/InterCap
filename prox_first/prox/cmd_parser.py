...
def parse_config(argv=None):
    ...
    # Newly added, for batch index
    parser.add_argument('--batch_id', type=int, default=0,
                        help='The batch to handle')
    ...
    parser.add_argument('--focal_length_x_2',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--focal_length_y_2',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--camera_center_x_2',
                        default=None,
                        type=float,
                        help='Value of camera center x.')
    parser.add_argument('--camera_center_y_2',
                        default=None,
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--rotation_2',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--translation_2',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')

    parser.add_argument('--focal_length_x_3',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--focal_length_y_3',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--camera_center_x_3',
                        default=None,
                        type=float,
                        help='Value of camera center x.')
    parser.add_argument('--camera_center_y_3',
                        default=None,
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--rotation_3',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--translation_3',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')

    parser.add_argument('--focal_length_x_4',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--focal_length_y_4',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--camera_center_x_4',
                        default=None,
                        type=float,
                        help='Value of camera center x.')
    parser.add_argument('--camera_center_y_4',
                        default=None,
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--rotation_4',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--translation_4',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')
    ...
    parser.add_argument('--focal_length_x_5',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--focal_length_y_5',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--camera_center_x_5',
                        default=None,
                        type=float,
                        help='Value of camera center x.')
    parser.add_argument('--camera_center_y_5',
                        default=None,
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--rotation_5',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--translation_5',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')
    ...
    parser.add_argument('--focal_length_x_6',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--focal_length_y_6',
                        default=5000,
                        type=float,
                        help='Value of focal length.')
    parser.add_argument('--camera_center_x_6',
                        default=None,
                        type=float,
                        help='Value of camera center x.')
    parser.add_argument('--camera_center_y_6',
                        default=None,
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--rotation_6',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')
    parser.add_argument('--translation_6',
                        default=[0.0, 0.0, 0.0],
                        nargs='*',
                        type=float,
                        help='Value of camera center y.')
